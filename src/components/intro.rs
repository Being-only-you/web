...
fn SocialIcons() -> impl IntoView {
    let socials = [
        Social {
            name: "Mail",
            url: "mailto:jordan:libertyware.co.uk",
        },
        Social {
            name: "GitHub",
            url: "https://github.com/jordan-hall",
        },
        Social {
            name: "LinkedIn",
            url: "https://linkedin.com/in/Jordan-hall",
        },
        Social {
            name: "Twitter",
            url: "https://twitter.com/jordanhall_dev",
        },
    ];
